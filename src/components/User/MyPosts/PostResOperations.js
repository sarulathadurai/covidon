...
const mapDispatchToProps = (dispatch) => {
    return{
        delete_post:(id) => dispatch(deleteResPost(id)),
        update_post:(id,value) => dispatch(updateResPost(id,value))
    }
}

export default connect(null,mapDispatchToProps)(PostResOperations);